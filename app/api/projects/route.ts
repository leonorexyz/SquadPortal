...
import { createProject, listProjects, ProjectOwnerError } from "../../../lib/projects/service";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const input = projectInputSchema.parse({ ...payload, ownerId: payload.ownerId ?? authorization.user.id });
