...
export default function TicketDetailPage() {
  ...
  function postReply() {
    ...
    if (!body) return;
    setReplyList((current) => [...current, { author: currentUser.name, initials: currentUser.initials, color: "purple", time: "just now", body }]);
    setReplyBody("");
    setReplyPosted(true);
  }
